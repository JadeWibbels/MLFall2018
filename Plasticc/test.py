...
#score = model.evaluate(full_test, verbose = 1)
#print(score[0], score[1])
#print(multi_weighted_logloss(y_valid, model.evaluate(full_test)))
#model = load_model('p_model.h5')   
#print("saving Model")    
score = model.predict_proba(test_matrix_ss, verbose = 1)
print(score[0])
print(score[1])    
